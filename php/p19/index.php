...
<ul>
<div class="search">
<li><input type="text" name="keyword" size="40"autofocus placeholder="msaukkan keyword pencarian" autocomplete="off" required value="" id="keyword"></li>
<li><button type="submit" name="cari" id="tombol-cari">Cari Data</button></li>
