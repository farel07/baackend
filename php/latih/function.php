...
function registerClient($data){
    ...
    // cek apakaah ada username yang sama
    $result = mysqli_query($database, "SELECT username FROM clientusers WHERE username = '$username'");
    ...
    $password = password_hash($password, PASSWORD_DEFAULT);
    // masukkan data ke database
    mysqli_query($database,"INSERT INTO clientusers VALUES('','$username','$password','')
    ");
